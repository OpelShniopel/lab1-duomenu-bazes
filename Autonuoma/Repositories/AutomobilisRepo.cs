...
public class AutomobilisRepo
{
	...
	{
		var query = $@"SELECT * FROM `auto_busenos` ORDER BY id ASC";
		var drc = Sql.Query(query);
	...
	{
		var query = $@"SELECT * FROM `pavaru_dezes` ORDER BY id ASC";
		var drc = Sql.Query(query);
	...
	{
		var query = $@"SELECT * FROM `kebulu_tipai` ORDER BY id ASC";
		var drc = Sql.Query(query);
	...
	{
		var query = $@"SELECT * FROM `degalu_tipai` ORDER BY id ASC";
		var drc = Sql.Query(query);
	...
	{
		var query = $@"SELECT * FROM `lagaminai` ORDER BY id ASC";
		var drc = Sql.Query(query);
